...
Before we start playing with the timer peripherals themselves, let's ground ourselves with the basics: initially we're going to make that on-board LED blink.
Then, we'll have a play with the timers and see how they can be made to be useful.
